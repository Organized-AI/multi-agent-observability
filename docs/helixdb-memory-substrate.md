...
Repo: `Organized-AI/multi-agent-observability`  
Branch: `helix`  
Created: 2026-06-12  
Fit label: **Cross-run agent observability graph**

## Why this branch exists

This branch marks `Organized-AI/multi-agent-observability` as one of the labeled Organized-AI HelixDB fits. The intent is not to replace Penumbra as a review/capture surface; it is to evaluate HelixDB as an owned, programmable backend for operational memory.
...
Add graph queries across sessions, agents, tools, files, errors, cost, outcomes, and semantic memory on top of hook/SQLite/WebSocket dashboard flows.
